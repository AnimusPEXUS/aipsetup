...
srcdir='../01.SOURCE'
CC='gcc'
CFLAGS='-g -O2 -pthread -I/multihost/x86_64-pc-linux-gnu/include/guile/2.0 -I/multihost/x86_64-pc-linux-gnu/include'
CPPFLAGS=''
LDFLAGS='-Wl,--export-dynamic '
ALLOCA=''
LOADLIBES='-ldl  -L/multihost/x86_64-pc-linux-gnu/lib64 -lguile-2.0 -lgc '
eval extras=\'\'
REMOTE='stub'
GLOBLIB=''
PATH_SEPARATOR=':'
