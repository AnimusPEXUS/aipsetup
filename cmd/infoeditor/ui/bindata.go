...
func uiMainGlade() (*asset, error) {
	...
	info := bindataFileInfo{name: "ui/main.glade", size: 15871, mode: os.FileMode(420), modTime: time.Unix(1516323761, 0)}
